...
- **Multiple Algorithms**: Visualize Bubble Sort, Selection Sort, and Insertion Sort
- **Interactive Controls**: Adjust speed and array size
- **Custom Input**: Input your own array values
